...
<#include "head.ftl">
<#--图片列表-->
<#assign imgageList=goodsDesc.itemImages?eval>
				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom">
								<#if (imgageList?size>0)>
									<img jqimg="${imgageList[0].url}" src="${imgageList[0].url}" width="400px" height="400px" />
								</#if>
							</span>
						</div>
						<!--下方的缩略图-->
